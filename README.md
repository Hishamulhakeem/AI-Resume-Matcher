...
│── templates/index.html      # Frontend UI (Generated using ChatGPT)
│── AI Matcher.ipynb          # Jupyter Notebook for model training
│── data/Resume_dataset.csv   # Dataset used for training
...
Model: Scikit-Learn's RandomForestClassifier or LogisticRegression
...
Results are displayed with matching/probability scores.
