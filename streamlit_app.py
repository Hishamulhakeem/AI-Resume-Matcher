...
st.markdown("""
    <style>
        ...
        .container { background-color: #262626; border-radius: 20px; padding: 40px; width: 480px; box-shadow: 0 12px 30px rgba(0, 0, 0, 0.7); text-align: center; margin-top: 50px; color: #f4f4f4; }
        h1 { margin-bottom: 25px; color: #f4f4f4; font-size: 32px; border-bottom: 2px solid #666; padding-bottom: 10px; letter-spacing: 1px; }
        ...
        .analyze-button { padding: 12px 30px; background-color: #666; color: white; border: none; border-radius: 10px; cursor: pointer; margin-bottom: 20px; font-weight: bold; transition: 0.3s; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.4); }
