...
st.markdown("""
    <style>
        ...
        .file-uploader { margin: 20px 0; color: #f4f4f4; font-weight: bold; }
        .analyze-button { padding: 10px 20px; background-color: #666; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold; transition: 0.3s; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.4); }
